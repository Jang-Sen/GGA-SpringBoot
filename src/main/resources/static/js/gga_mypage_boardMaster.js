	...
	function initAjax(page) {
		$.ajax({
			...
			success : function(myReview){
				...
				for(obj of myReview.list) {
			        ...
			        if(obj.movieName == "suzume"){
		          	...
		          	if(obj.commentCount > 0){
		          		output += "<div class='maxSize'><a href=" + "'" + "/board_content/" + page + "/" + obj.bid + "'>"+obj.btitle+"</a>("+obj.commentCount+")</td>";
		          	}else{
		          		output += "<div class='maxSize'><a href=" + "'" + "/board_content/" + page + "/" + obj.bid + "'>"+obj.btitle+"</a></td>";
		          	}
				...
				pager(myReview.page.dbCount, myReview.page.pageCount, myReview.page.pageSize, myReview.page.reqPage);
