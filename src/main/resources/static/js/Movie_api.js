                ...
                $.getJSON(url, function(kobis){
                    ...
                    $("#movieName0").click(function (){
                       // alert("진입 성공!");
                        ...
                        if(soyoon != "") {
                            url = "http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_json2.jsp?collection=kmdb_new2&ServiceKey=923G54G6VL3W1VEO4A7P&detail=Y&query="+soyoon;
                            mainPoster(url);
                        }
                    });
                    ...
                    function mainPoster(url){
                       ...
                       // alert(url);
                        $.getJSON(url, function(kmdb){
                            ...
                            output += "</div>";
                            output += "<p id='movieTitle'>"+kmdb.Query+"</p>";
