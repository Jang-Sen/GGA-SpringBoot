...
<body>
	...
	<section class="productorder">
		<div id="paytitlediv">
			<img src="http://localhost:9000/images/paytitle.png" id="paytitle">
			<br>
			<br>
		</div>
			...
			<div id="movieorderdiv">
				...
				<div id="movieorderdiv2">
					...
					<p>제목 : ${orderDto.movieordertitle}</p>
						<p>날짜 : ${orderDto.odate}</p>
		...
		<br>
			...
			<div id="paydiv">
				<h2>결제 수단</h2>
				<button type="button" class="paymethod" id="selectedcard" data-id="kcp">카드</button>
				<br>
				<button type="button" class="paymethod" id="selectedkakaopay" data-id="kakaopay">카카오페이</button>
				<button type="button" class="paymethod" id="selectedpayco" data-id="payco">페이코</button>
				<button type="button" class="paymethod" id="selectedbank" data-id="tosspay">토스페이</button>
		...
		<div class="row text-center" id="orderpaymentBtndiv">
			<button type="button" class="btn" id="orderpaymentBtn"><img src="http://localhost:9000/images/buybtn.png"></button>
		</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="couponModalLabel">쿠폰 조회</h5>
				...
				<div class="modal-body">
						...
						<tr>
							...
							<td style="color: cornflowerblue">
								<c:out value="${orderDto.price - coupon.discount}" />원</td>
							<td>
								...
								<div class="text-center">
									<button type="button" class="btn btn-secondary" data-bs-dismiss="modal"  id="couponclose2">닫기</button>
							...
							<table class="table text-center" style="font-size: 16px">
								...
								<tr>
									<td colspan="5" class="text-center">사용 가능한 쿠폰이 없습니다.</td>

								</tr>

							</table>
								<div class="text-center">
									<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="couponclose">닫기</button>
								</div>
