                ...
                <c:choose>
                    <c:when test="${svo == null }">
                        <div class="store_cart">
                            <a href="http://localhost:9000/login?redirectURL=/store/beverage">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="storebtns">
                                ...
                                <c:choose>
                                    <c:when test="${svo == null }">
                                        <a class="cartbtn3" class="productbuybtn" href="http://localhost:9000/login?redirectURL=/store/beverage">
