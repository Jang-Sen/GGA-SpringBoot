                ...
                <c:choose>
                    <c:when test="${svo == null }">
                        <div class="store_cart">
                            <a href="http://localhost:9000/login?redirectURL=/store/card">
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="storebtns">
                                ...
                                <c:choose>
                                    <c:when test="${svo == null }">
                                        <a class="cartbtn3" class="productbuybtn"  href="http://localhost:9000/login?redirectURL=/store/card">
                                            <img src="http://localhost:9000/images/buybtn.png"></a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="cartbtn2" class="productbuybtn" class="cartbtn2" id="${product.pid}">
                                            <img src="http://localhost:9000/images/buybtn.png"></a>
                                    </c:otherwise>
                                </c:choose>
                            </div>
