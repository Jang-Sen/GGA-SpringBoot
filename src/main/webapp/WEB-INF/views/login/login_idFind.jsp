...
<body>
	...
	<div class="container">
		...
		<section class="login">
			<form name="findIdForm" action="login_idFind_proc" method="get" class="loginForm" id="findIdForm">
				<ul>
					<li>
						<label>이름</label>
					...
					<li>
						<img src="http://localhost:9000/images/schbtn.png" id="btnFindId" class="btnfindproc">
					</li>
				</ul>
			</form>
		</section>
